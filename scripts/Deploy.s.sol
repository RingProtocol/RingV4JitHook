...
/// @dev    The hook address must carry the permission flags `0x20C0` in its low
...
contract Deploy is Script {
    ...
    uint160 internal constant REQUIRED_FLAGS = 0x20C0;
    ...
    function run() public returns (address hook, address router) {
        ...
        // ------------------------------------------------------------------
        // 1. Mine a CREATE2 salt so the hook address carries the flags 0x20C0.
        // ------------------------------------------------------------------
